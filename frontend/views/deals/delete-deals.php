...
/** @var frontend\models\DeleteDeals $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Удаленные сделки';
...
<div class="branch-index">
    ...
    <div class="alert alert-danger">Отредактированная сделка вернется в работу</div>
    <?php Pjax::begin(); ?>
...
// esli nujen select
            ...
            [
                ...
                'header' =>    Html::a('Сбросить фильтр', ['deals/delete-deals'], ['class' => 'btn btn-sm btn-outline-primary']),
